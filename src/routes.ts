...
//  { path: "/progetti/sophiatheme", component: lazy(() => import("./pages/editorial/SophiaTheme")) },
  ...
  { path: "/sviluppo-cms", component: lazy(() => import("./pages/editorial/CMSDetails")) },
  { path: "/sviluppo-mvp", component: lazy(() => import("./pages/editorial/MVPDetails")) },
  { path: "/sviluppo-custom", component: lazy(() => import("./pages/editorial/CustomDetails")) },
...
//  { path: "/progetti/sophiatheme", component: lazy(() => import("./pages/nebula/SophiaTheme")) },
  ...
  { path: "/sviluppo-cms", component: lazy(() => import("./pages/nebula/CMSDetails")) },
  { path: "/sviluppo-mvp", component: lazy(() => import("./pages/nebula/MVPDetails")) },
  { path: "/sviluppo-custom", component: lazy(() => import("./pages/nebula/CustomDetails")) },
