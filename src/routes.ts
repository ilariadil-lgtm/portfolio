...
//  { path: "/progetti/sophiatheme", component: lazy(() => import("./pages/editorial/SophiaTheme")) },
  ...
  { path: "/sito-aziendale", component: lazy(() => import("./pages/editorial/SitoAziendale")) },
  { path: "/e-commerce", component: lazy(() => import("./pages/editorial/Ecommerce")) },
  { path: "/restyling", component: lazy(() => import("./pages/editorial/Restyling")) },
  { path: "/manutenzione", component: lazy(() => import("./pages/editorial/Manutenzione")) },
...
//  { path: "/progetti/sophiatheme", component: lazy(() => import("./pages/nebula/SophiaTheme")) },
  ...
  { path: "/sito-aziendale", component: lazy(() => import("./pages/nebula/SitoAziendale")) },
  { path: "/e-commerce", component: lazy(() => import("./pages/nebula/Ecommerce")) },
  { path: "/restyling", component: lazy(() => import("./pages/nebula/Restyling")) },
  { path: "/manutenzione", component: lazy(() => import("./pages/nebula/Manutenzione")) },
