...
export const NebulaStorageHub = () => {
  ...
  const phasesData: Phase[] = [
    ...
    },
    {
      ...
      description: <p className="border-l-2 border-[#d4af37]/30 pl-4 py-2 italic text-white/80 pr-2">{t('storagehub.ch2_title1')}<span className="text-[#d4af37] italic pr-2">{t('storagehub.ch2_title2')}</span>{t('storagehub.ch2_title3')}</p>,
