...
const Ecommerce = () => {
  ...
  usePageMeta({
    title: t("service_ecommerce.title"),
  ...
  useEffect(
    () =>
      injectSchema({
        "@type": "Service",
        name: t("service_ecommerce.title"),
  ...
  return (
    <NebulaProjectLayout
      ...
      role={`${t("project_nav.service_label")}_02`}
      year={t("service_ecommerce.tempi")}
      roleLabel={t("project_nav.service_label")}
      yearLabel={t("service_detail.timing")}
      techList={[
        t("service_ecommerce.tag1"),
        t("service_ecommerce.tag2"),
        t("service_ecommerce.tag3"),
        t("service_ecommerce.tag4"),
      ]}
      description={
