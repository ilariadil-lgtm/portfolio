...
const getFallbackProjects = (t: any) => [
  {
    ...
    type: "WEBAPP_SAAS",
    technologies: t(
      "projects_data.storagehub.technologies",
  ...
  },
  {
    ...
    technologies: t(
      "projects_data.villamasami.technologies",
  ...
  },
  {
    ...
    type: "WEB_ECOMMERCE",
    technologies: t(
      "projects_data.pattiforniture.technologies",
  ...
  },
  {
    ...
    type: "WEB_ECOMMERCE",
    technologies: t(
      "projects_data.sicilcosmetic.technologies",
  ...
  },
  {
    ...
    type: "WEB_ECOMMERCE",
    technologies: t(
      "projects_data.newpop.technologies",
  ...
  },
  {
    ...
    type: "WEB_ECOMMERCE",
    technologies: t(
      "projects_data.vinigambino.technologies",
  ...
  },
  {
    ...
    type: "WEB_ECOMMERCE",
    technologies: t(
      "projects_data.bagliolauria.technologies",
  ...
  },
  {
    ...
    type: "WEB_ECOMMERCE",
    technologies: t(
      "projects_data.villamima.technologies",
            ...
            {typeof project.technologies === "string"
              ? project.technologies
                  ...
                  .map((tech: string) => (
                    <span
                      key={tech}
                      className="px-3 py-1 border border-white/10 bg-white/[0.02] text-white/60 text-[8px] uppercase tracking-[0.1em] font-mono rounded-full"
                    >
                      {tech.trim()}
                    </span>
                  ))
          ...
          <div className="flex items-center justify-center py-5">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2">
              {categoriesWithCount.map((cat) => (
                ...
                >
                  {cat.label}{" "}
                  <sup className="ml-1 opacity-60 font-medium">{cat.count}</sup>
                </button>
              ))}
            </div>
          </div>
