              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-white/10 pt-8">
                  {[
                    {
                      num: "I.",
                      label: t("about.rule1_label"),
                      desc: t("about.rule1_desc"),
                    },
                    {
                      num: "II.",
                      label: t("about.rule2_label"),
                      desc: t("about.rule2_desc"),
                    },
                    {
                      num: "III.",
                      label: t("about.rule3_label"),
                      desc: t("about.rule3_desc"),
                    },
                  ].map((rule, idx) => (
              ...
              {evolution.map((step, i) => (
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col flex-grow">
                    ...
                    {/* Body: Title & Desc */}
                    <div className="mb-12">
                      <h3 className="font-bricolage text-2xl lg:text-3xl font-bold text-white/90 mb-2 group-hover:text-white transition-colors">
                        {step.title}
                      </h3>
                      <span className="font-mono text-[8px] uppercase tracking-[0.4em] text-white/30 font-bold block mb-4">
                        {step.subtitle}
                      </span>
                    ...
                    <div className="mt-auto pt-6 border-t border-white/5 group-hover:border-[#d4af37]/10 transition-colors">
                      <span className="font-mono text-[8px] uppercase tracking-[0.3em] text-white/30 mb-4 block font-medium group-hover:text-white/50 transition-colors">
        ...
        <section className="py-24 md:py-36 px-6 md:px-12 lg:px-24 border-t border-white/5 relative z-20 snap-start">
          <div className="max-w-7xl mx-auto">
            <div className="mb-24 text-center md:text-left">
              ...
              <RevealText
                text={
                  t("about.skills_title_1") + " " + t("about.skills_title_2")
                }
                className="font-bricolage text-5xl md:text-7xl font-bold leading-none tracking-tighter text-white"
              />
            </div>
                ...
                : [
                    {
                      ...
                      tags: ["UI Design", "UX Research", "Brand Identity"],
                    },
                    {
                      title: t("about.fallback2_title"),
                      desc: t("about.fallback2_desc"),
                      tags: ["React / Next.js", "WebGL", "Framer Motion"],
                    },
                    {
                      title: t("about.fallback3_title"),
                      desc: t("about.fallback3_desc"),
                      tags: ["Architecture", "Django", "System Design"],
                    },
                  ].map((tech, i) => (
                    <motion.div
                      key={i}
