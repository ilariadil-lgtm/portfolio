              ...
              <h1 className="relative font-display leading-[1.1] md:leading-[0.85] tracking-tighter">
                <div className="overflow-hidden pt-4 pb-24 -mb-20 w-max">
                  <motion.span
                    ...
                    className="block text-[10vw] lg:text-[clamp(2rem,5.0vw,5.0rem)] font-bold text-ink whitespace-nowrap pr-4"
                    style={{ y: y1 }}
                  >
                    Patti{" "}
          ...
          >
            <h2
              ...
              dangerouslySetInnerHTML={{
                __html: t("pattiforniture.ch1_title1"),
              }}
            />
            <div className="space-y-6 text-ink/70 font-body text-lg leading-relaxed max-w-2xl">
              <p>{t("pattiforniture.ch1_p1")}</p>
              <p>{t("pattiforniture.ch1_p2")}</p>
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto flex justify-center">
          ...
          >
            ...
            <h3
              ...
              dangerouslySetInnerHTML={{
                __html: t("pattiforniture.ch2_title1"),
              }}
            />
          </motion.div>
        </div>
          ...
          >
            <div>
              ...
              <div className="space-y-6 text-ink/70 font-body text-lg leading-relaxed">
                <p>{t("pattiforniture.ch3_p1")}</p>
                <p>{t("pattiforniture.ch3_p2")}</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          >
            ...
            <div className="font-body text-ink/70 text-lg leading-relaxed space-y-6">
              <p>{t("pattiforniture.ch4_p1")}</p>
              <p>{t("pattiforniture.ch4_p2")}</p>
            </div>
          </motion.div>
