        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          >
            <h2
              ...
              dangerouslySetInnerHTML={{ __html: t("villamasami.ch1_title1") }}
            />
            <div className="space-y-6 text-ink/70 font-body text-lg leading-relaxed max-w-2xl">
              <p>{t("villamasami.ch1_p1")}</p>
              <p>{t("villamasami.ch1_p2")}</p>
            </div>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto flex justify-center">
          ...
          >
            ...
            <h3
              ...
              dangerouslySetInnerHTML={{ __html: t("villamasami.ch2_title1") }}
            />
          </motion.div>
        </div>
      </section>
          ...
          >
            <div>
              ...
              <div className="space-y-6 text-ink/70 font-body text-lg leading-relaxed">
                <p>{t("villamasami.ch3_p1")}</p>
                <p>{t("villamasami.ch3_p2")}</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          >
            ...
            <div className="font-body text-ink/70 text-lg leading-relaxed space-y-6">
              <p>{t("villamasami.ch4_p1")}</p>
              <p>{t("villamasami.ch4_p2")}</p>
            </div>
          </motion.div>
