  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="flex justify-between items-start border-b border-ink/10 pb-6 mb-8">
        ...
        <div className="space-y-6 mb-8">
          <div className="flex items-baseline gap-4 min-h-[80px] lg:min-h-[120px]">
            <span className="font-display text-4xl md:text-5xl font-black text-ink/10 select-none">
              0{idx + 1}
            </span>
        ...
        <div className="mb-6 flex justify-between items-center">
          <button
            ...
            data-cursor="pointer"
            className="font-typewriter text-[9px] uppercase tracking-widest text-ink border border-ink/20 hover:bg-ink/5 hover:border-ink/50 px-3 py-1.5 transition-all duration-300 relative z-20 font-bold cursor-pointer"
          >
            {showSpecs
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="font-mono text-[7px] text-ink/65">
              {t("services.aligned")}
            </span>
          </div>
        </div>
        ...
        <AnimatePresence>
          {showSpecs && (
            ...
            >
              <div className="font-mono text-[10px] divide-y divide-primary/10 bg-cream p-5 border border-primary/15 space-y-3 shadow-inner">
                <div className="flex justify-between pb-2">
                  <span className="text-ink/65 uppercase tracking-widest text-[8px]">
                    {t("services.tools")}
                  </span>
                ...
                <div className="pt-2">
                  <span className="text-ink/65 uppercase tracking-widest text-[8px] block mb-2">
                    {t("services.skills")}
                  </span>
                  <div className="flex flex-wrap gap-1.5">
                    {specs.tools.map((t: string, i: number) => (
                      <span
                        key={i}
                        className="bg-primary/10 text-ink border border-ink/10 px-2 py-0.5 rounded-sm text-[8px] uppercase tracking-wider font-bold"
                      >
                        {t}
                      </span>
                    ))}
      ...
      {/* Deliverables List */}
      <div className="space-y-4 pt-6 border-t border-ink/10 relative z-10 mt-auto">
        ...
        <ul className="space-y-2.5">
          {(
            ...
            <li key={dIdx} className="flex items-center gap-3">
              ...
              <span className="font-typewriter text-[10px] uppercase tracking-widest text-ink/80 font-bold">
                {del}
              </span>
            </li>
          ))}
    ...
    <div className="min-h-[100dvh] bg-cream text-ink overflow-hidden selection:bg-primary/30">
      ...
      <section className="py-24 md:py-32 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto border-t border-ink/10">
        <div className="mb-16">
           ...
           <p className="mt-6 font-body text-lg text-ink/70 max-w-2xl">
      ...
      <section className="pb-24 md:pb-32 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        <div className="mb-16 text-left">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-ink leading-tight tracking-tighter max-w-3xl mx-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="border border-ink bg-cream p-8 flex flex-col group hover:bg-white hover:border-primary transition-all duration-300 shadow-soft-6 hover:shadow-brutal-6">
            <div className="mb-8">
              ...
              <p className="font-body text-[14px] text-ink/70 min-h-[60px]">
                {t("services.pkg_cms_desc")}
              </p>
            </div>
            
            <div className="mb-8 pb-8 border-b border-ink/10">
              <span className="font-display text-3xl font-black text-ink">{t("services.pkg_cms_time")}</span>
              <span className="font-body text-sm text-ink/65 ml-2">{t("services.pkg_cms_time_unit")}</span>
            </div>

            <ul className="space-y-4 mb-10 flex-grow">
              <li className="flex items-start gap-3">
                <CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" />
                <span className="font-body text-[14px] text-ink/80">{t("services.pkg_cms_p1")}</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" />
                <span className="font-body text-[14px] text-ink/80">{t("services.pkg_cms_p2")}</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" />
                <span className="font-body text-[14px] text-ink/80">{t("services.pkg_cms_p3")}</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" />
                <span className="font-body text-[14px] text-ink/80">{t("services.pkg_cms_p4")}</span>
              </li>
            </ul>

            <Link to="/sviluppo-cms" className="w-full py-4 border border-ink text-center font-typewriter text-[10px] uppercase tracking-[0.2em] font-bold text-ink group-hover:bg-ink group-hover:text-white transition-colors duration-300 inline-block">
          ...
          <div className="border-2 border-primary bg-white p-8 flex flex-col group relative shadow-brutal-8 md:-mt-4 md:mb-4">
            ...
            <div className="mb-8 mt-2">
              <h3 className="font-display text-2xl font-bold text-ink mb-2">{t("services.pkg_mvp_name")}</h3>
              <p className="font-typewriter text-[9px] uppercase tracking-widest text-ink/65 font-bold mb-6">{t("services.pkg_mvp_tagline")}</p>
              <p className="font-body text-[14px] text-ink/70 min-h-[60px]">
            ...
            <div className="mb-8 pb-8 border-b border-ink/10">
              <span className="font-display text-3xl font-black text-ink">{t("services.pkg_mvp_time")}</span>
              <span className="font-body text-sm text-ink/65 ml-2">{t("services.pkg_mvp_time_unit")}</span>
            </div>

            <ul className="space-y-4 mb-10 flex-grow">
              <li className="flex items-start gap-3">
                <CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" />
                <span className="font-body text-[14px] text-ink/80">{t("services.pkg_mvp_p1")}</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" />
                <span className="font-body text-[14px] text-ink/80">{t("services.pkg_mvp_p2")}</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" />
                <span className="font-body text-[14px] text-ink/80">{t("services.pkg_mvp_p3")}</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" />
                <span className="font-body text-[14px] text-ink/80">{t("services.pkg_mvp_p4")}</span>
              </li>
            </ul>

            <Link to="/sviluppo-mvp" className="w-full py-4 bg-primary text-white text-center font-typewriter text-[10px] uppercase tracking-[0.2em] font-bold hover:bg-ink transition-colors duration-300 inline-block">
          ...
          <div className="border border-ink bg-cream p-8 flex flex-col group hover:bg-white hover:border-primary transition-all duration-300 shadow-soft-6 hover:shadow-brutal-6">
            ...
            <div className="mb-8 pb-8 border-b border-ink/10">
              <span className="font-display text-3xl font-black text-ink">{t("services.pkg_custom_time")}</span>
              <span className="font-body text-sm text-ink/65 ml-2">{t("services.pkg_custom_time_unit")}</span>
            </div>

            <ul className="space-y-4 mb-10 flex-grow">
              <li className="flex items-start gap-3">
                <CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" />
                <span className="font-body text-[14px] text-ink/80">{t("services.pkg_custom_p1")}</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" />
                <span className="font-body text-[14px] text-ink/80">{t("services.pkg_custom_p2")}</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" />
                <span className="font-body text-[14px] text-ink/80">{t("services.pkg_custom_p3")}</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" />
                <span className="font-body text-[14px] text-ink/80">{t("services.pkg_custom_p4")}</span>
              </li>
            </ul>

            <Link to="/sviluppo-custom" className="w-full py-4 border border-ink text-center font-typewriter text-[10px] uppercase tracking-[0.2em] font-bold text-ink group-hover:bg-ink group-hover:text-white transition-colors duration-300 inline-block">
      ...
      {/* ═══════════════════════════════════════════════════════════════════
           ...
           ═══════════════════════════════════════════════════════════════════ */}
      <section className="py-24 md:py-36 px-6 md:px-12 lg:px-24 bg-white border-y border-ink/5 relative">
        {/* Grid Background */}
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="mb-16 relative z-10">
            ...
            <h2 className="font-display text-5xl md:text-7xl font-bold leading-none tracking-tighter text-ink">
            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <div className="flex justify-between items-baseline mb-8">
                  <span className="font-display text-5xl font-black text-ink/15 group-hover:text-primary transition-colors select-none leading-none">
                    {step.num}
                  </span>
                ...
                {/* Title and Narrative */}
                <h3 className="font-display text-xl font-bold mb-4 text-ink group-hover:text-primary transition-colors duration-300">
                  {step.title}
                </h3>
