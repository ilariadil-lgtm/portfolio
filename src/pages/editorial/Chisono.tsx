...
const Chisono = () => {
  ...
  usePageMeta({
    title: "Chi Sono",
    description:
      "Ilaria Diliberto — Designer e sviluppatrice full-stack. Dalla Accademia di Belle Arti al prodotto digitale: il percorso che unisce estetica, codice e strategia.",
  });
  ...
  return (
    <div className="min-h-[100dvh] bg-cream text-ink overflow-hidden selection:bg-primary/30">
      ...
      {/* ═══════════════════════════════════════════════════════════════════
           ...
           ═══════════════════════════════════════════════════════════════════ */}
      <section className="pt-56 md:pt-52 pb-20 px-6 md:px-12 lg:px-24 relative overflow-hidden">
                ...
                >
                  ...
                  <span className="overflow-hidden inline-block py-3 -my-3">
                    <motion.span
                      ...
                      className="inline-block origin-bottom-left text-primary italic pr-2"
                    >
                      &nbsp;{t("about.title_2")}
                    </motion.span>
                  </span>
