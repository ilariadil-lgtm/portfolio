              ...
              >
                ...
                <div className="relative bg-white border border-[#3d0f1a] p-8 md:p-10 flex flex-col h-full text-[#3d0f1a] z-10">
                  ...
                  <div className="space-y-4 flex-1 mb-10">
                    <div className="flex items-start gap-3"><CheckCircle2 size={18} className="text-[#3d0f1a] mt-0.5 shrink-0 opacity-80" strokeWidth={1.5} /><span className="font-body text-[15px] text-[#3d0f1a]/90">UI/UX Design personalizzato</span></div>
<div className="flex items-start gap-3"><CheckCircle2 size={18} className="text-[#3d0f1a] mt-0.5 shrink-0 opacity-80" strokeWidth={1.5} /><span className="font-body text-[15px] text-[#3d0f1a]/90">Sviluppo front-end reattivo</span></div>
<div className="flex items-start gap-3"><CheckCircle2 size={18} className="text-[#3d0f1a] mt-0.5 shrink-0 opacity-80" strokeWidth={1.5} /><span className="font-body text-[15px] text-[#3d0f1a]/90">Setup piattaforma headless o ibrida</span></div>
<div className="flex items-start gap-3"><CheckCircle2 size={18} className="text-[#3d0f1a] mt-0.5 shrink-0 opacity-80" strokeWidth={1.5} /><span className="font-body text-[15px] text-[#3d0f1a]/90">Training per gestione contenuti</span></div>
<div className="flex items-start gap-3"><CheckCircle2 size={18} className="text-[#3d0f1a] mt-0.5 shrink-0 opacity-80" strokeWidth={1.5} /><span className="font-body text-[15px] text-[#3d0f1a]/90">4-6 settimane di sviluppo</span></div>
                  </div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="border-2 border-primary bg-white p-8 md:p-10 flex flex-col group relative shadow-[8px_8px_0px_#c0392b]">
              ...
              <div className="mb-8 mt-2 pb-8 border-b border-[#3d0f1a]/10 flex justify-between items-end">
                <div>
                  ...
                  <span className="font-display text-3xl font-black text-[#3d0f1a]">4-6 Sett.</span>
                </div>
              ...
              <div className="mb-10">
                ...
                <ul className="space-y-4 flex-grow">
                  <li className="flex items-start gap-3"><CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" /><span className="font-body text-[14px] text-[#3d0f1a]/80">UI/UX Design personalizzato</span></li>
<li className="flex items-start gap-3"><CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" /><span className="font-body text-[14px] text-[#3d0f1a]/80">Sviluppo front-end reattivo</span></li>
<li className="flex items-start gap-3"><CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" /><span className="font-body text-[14px] text-[#3d0f1a]/80">Setup piattaforma headless o ibrida</span></li>
<li className="flex items-start gap-3"><CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" /><span className="font-body text-[14px] text-[#3d0f1a]/80">Training per gestione contenuti</span></li>
<li className="flex items-start gap-3"><CheckCircle2 size={16} className="text-primary shrink-0 mt-0.5" /><span className="font-body text-[14px] text-[#3d0f1a]/80">4-6 settimane di sviluppo</span></li>
                </ul>
              </div>
...
<span className="px-3 py-1.5 border border-[#3d0f1a]/20 font-typewriter text-[9px] uppercase tracking-widest text-[#3d0f1a]/80 font-semibold">WordPress/Sanity</span>
