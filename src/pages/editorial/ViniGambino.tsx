        ...
        <div className="max-w-7xl mx-auto flex justify-center">
          ...
          >
            ...
            <h3
              ...
              dangerouslySetInnerHTML={{ __html: t("vinigambino.ch2_title1") }}
            />
          </motion.div>
        </div>
      </section>
            ...
            <div className="relative w-full min-h-[400px] lg:h-full max-w-[720px] lg:max-w-none">
              ...
              <div className="relative z-10 w-full h-full flex gap-4 overflow-x-auto snap-x snap-mandatory pb-4 hide-scrollbar">
                {[
                  ...
                  <div
                    key={idx}
                    className="shrink-0 w-[85%] md:w-[70%] h-[300px] md:h-[400px] lg:h-full snap-center bg-[#f5f2ed] border border-[#3d0f1a] shadow-[10px_10px_0px_#3d0f1a] overflow-hidden group"
                  >
                    <img loading="lazy" decoding="async"
                      src={src}
          ...
          >
            <div>
              ...
              <div className="space-y-6 text-[#3d0f1a]/70 font-body text-lg leading-relaxed">
                <p>{t("vinigambino.ch3_p1")}</p>
                <p>{t("vinigambino.ch3_p2")}</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          >
            ...
            <div className="font-body text-[#3d0f1a]/70 text-lg leading-relaxed space-y-6">
              <p>{t("vinigambino.ch4_p1")}</p>
              <p>{t("vinigambino.ch4_p2")}</p>
            </div>
          </motion.div>
