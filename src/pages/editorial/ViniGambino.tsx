...
export const EditorialViniGambino = () => {
  ...
  usePageMeta({
    title: "Vini Gambino",
    description: t('vinigambino.meta_desc'),
  });
    ...
    <div className="min-h-[100dvh] bg-[#f5f2ed] text-[#3d0f1a] selection:bg-primary/30 font-body">
              ...
              <h1 className="relative font-display leading-[0.85] tracking-tighter">
                <div className="overflow-hidden pt-4 pb-24 -mb-20 w-max">
                  <motion.span
                    ...
                    style={{ y: y1 }}
                  >
                    Vini <span className="text-primary italic pr-2">Gambino</span><span className="text-[#3d0f1a] not-italic pr-2">.</span>
                  </motion.span>
                </div>
              </h1>
      ...
      <section className="px-6 md:px-12 lg:px-24 py-24 md:py-32 bg-white relative">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          >
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-black leading-[0.9] tracking-tighter text-[#3d0f1a]" dangerouslySetInnerHTML={{ __html: t('vinigambino.ch1_title1') }} />
            <div className="space-y-6 text-[#3d0f1a]/70 font-body text-lg leading-relaxed max-w-2xl">
              <p>
                {t('vinigambino.ch1_p1')}
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto flex justify-center">
          ...
          >
            <span className="font-typewriter text-[9px] uppercase tracking-[0.5em] text-[#3d0f1a]/40 block mb-12">
              {t('vinigambino.ch2_label')}
            </span>
            <h3 className="font-display text-3xl md:text-5xl lg:text-6xl font-black leading-[1.1] tracking-tighter text-[#3d0f1a]" dangerouslySetInnerHTML={{ __html: t('vinigambino.ch2_title1') }} />
          </motion.div>
        </div>
      </section >
            ...
            <div className="relative w-full min-h-[400px] lg:h-full max-w-[720px] lg:max-w-none">
              ...
              <div className="relative z-10 w-full h-full flex gap-4 overflow-x-auto snap-x snap-mandatory pb-4 hide-scrollbar">
                {[
                  ...
                  <div key={idx} className="shrink-0 w-[85%] md:w-[70%] h-[300px] md:h-[400px] lg:h-full snap-center bg-[#f5f2ed] border border-[#3d0f1a] shadow-[10px_10px_0px_#3d0f1a] overflow-hidden group">
                    <img
                      src={src}
            ...
            <div className="bg-white border border-[#3d0f1a] shadow-[10px_10px_0px_#3d0f1a] p-10 h-full flex flex-col justify-between">
              ...
              <div className="border-t border-[#3d0f1a]/10 pt-6 mt-12 space-y-4 text-[#3d0f1a]">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-display text-md font-black italic pr-2">{t('vinigambino.role_val')}</span>
                </div>
                <div className="flex items-center justify-between">
