    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
          ...
          <div className="relative z-10 p-8 md:p-16 lg:p-24 flex flex-col justify-between h-full min-h-[500px]">
            <div>
              ...
              <ul className="font-mono text-xs text-background/80 space-y-4 leading-relaxed">
                ...
                <li className="border-l-2 border-primary/40 pl-4 hover:border-primary/70 hover:pl-5 transition-all duration-300 cursor-default">PostgreSQL / Redis</li>
                <li className="border-l-2 border-primary/40 pl-4 hover:border-primary/70 hover:pl-5 transition-all duration-300 cursor-default">Docker / Kubernetes</li>
              </ul>
            </div>
      ...
      <section className="py-24 md:py-32 px-6 md:px-12 border-b border-editorial relative overflow-hidden">
        ...
        <div className="space-y-32 relative z-10">
          {[
            { id: "01", name: "FreeLens", type: "Web App / AWS", url: "/progetti", image: "/placeholder.svg", desc: "Piattaforma cloud-native per la gestione di contenuti visuali ad alta risoluzione" },
            { id: "02", name: "Visio", type: "Real-time Dashboard", url: "/progetti", image: "/placeholder.svg", desc: "Dashboard analytics in tempo reale con architettura serverless scalabile" },
            { id: "03", name: "Sophia", type: "Healthcare Platform", url: "/progetti", image: "/placeholder.svg", desc: "Ecosystem digitale per la telemedicina conforme GDPR e HIPAA" },
          ].map((item, i) => (
            <Link 
              key={item.id} 
              to={item.url}
