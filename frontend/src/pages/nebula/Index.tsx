      ...
      <main className="relative z-10 w-full min-h-screen flex flex-col">
              ...
              <div className="md:w-2/3 min-h-[250px] relative">
                <AnimatePresence mode="wait">
                  {activeTab === "Design" && (
                    ...
                    >
                      {["UI & UX Design", "Visual Identity", "Design Systems", "Prototipazione Iterativa", "Wireframing", "User Research", "Architettura dell'Informazione"].map((tag) => (
                        <span key={tag} className="px-6 py-4 border border-white/10 text-white/70 font-inter text-sm font-medium tracking-wide rounded-none hover:border-[#d4af37]/60 hover:text-[#d4af37] hover:bg-[#d4af37]/5 transition-all duration-300 cursor-default">
                          {tag}
                        </span>
                      ))}
                    </motion.div>
                  ...
                  {activeTab === "Sviluppo" && (
                    <motion.div
                      ...
                      className="flex flex-wrap gap-4"
                    >
                      {["Sviluppo Front-end", "Sviluppo Full-Stack", "Web App Custom", "Ottimizzazione Performance", "E-commerce su misura", "Temi WordPress", "PrestaShop", "Integrazione API"].map((tag) => (
                        <span key={tag} className="px-6 py-4 border border-white/10 text-white/70 font-inter text-sm font-medium tracking-wide rounded-none hover:border-[#d4af37]/60 hover:text-[#d4af37] hover:bg-[#d4af37]/5 transition-all duration-300 cursor-default">
                          {tag}
                        </span>
                      ))}
                  ...
                  {activeTab === "Strategia" && (
                    <motion.div
                      ...
                      className="flex flex-wrap gap-4"
                    >
                      {["Tech Product Management", "Analisi dei Requisiti", "Integrazione AI Workflows", "Coordinamento Agile", "Strategia Digitale", "SEO Tecnico", "Ottimizzazione Conversioni (CRO)"].map((tag) => (
                        <span key={tag} className="px-6 py-4 border border-white/10 text-white/70 font-inter text-sm font-medium tracking-wide rounded-none hover:border-[#d4af37]/60 hover:text-[#d4af37] hover:bg-[#d4af37]/5 transition-all duration-300 cursor-default">
                          {tag}
                        </span>
                      ))}
          ...
          >
            {[...Array(4)].map((_, i) => (
              <span key={i} className="inline-flex items-center gap-12 flex-shrink-0">
                <span className="font-bricolage font-bold text-sm uppercase tracking-[0.2em] text-white/20">UX ARCHITECTURE</span>
                <span className="text-[#d4af37]/40 text-xs">✦</span>
                <span className="font-bricolage font-bold text-sm uppercase tracking-[0.2em] text-white/20">DIGITAL STRATEGY</span>
                <span className="text-[#d4af37]/40 text-xs">✦</span>
                <span className="font-bricolage font-bold text-sm uppercase tracking-[0.2em] text-white/20">CLOUD DESIGN</span>
                <span className="text-[#d4af37]/40 text-xs">✦</span>
                <span className="font-bricolage font-bold text-sm uppercase tracking-[0.2em] text-white/20">IDENTITÀ VISIVA</span>
                <span className="text-[#d4af37]/40 text-xs">✦</span>
                <span className="font-bricolage font-bold text-sm uppercase tracking-[0.2em] text-white/20">ECOSISTEMI DIGITALI</span>
                <span className="text-[#d4af37]/40 text-xs">✦</span>
        ...
        >
          ...
          <div className="flex justify-center mt-20 px-6">
            <MagneticWrapper>
              <Link to="/progetti" className="group inline-flex items-center gap-4 font-mono text-[10px] uppercase tracking-[0.3em] text-white hover:text-[#d4af37] transition-colors duration-300">
