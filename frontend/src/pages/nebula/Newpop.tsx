  ...
  const phasesData: Phase[] = [
    {
      ...
      description: (
        <>
          <h2 className="font-bricolage font-bold text-3xl text-white mb-6">Progettare la casa iconica.</h2>
    ...
    },
    {
      ...
      description: (
        <>
          <h2 className="font-bricolage font-bold text-3xl text-white mb-6">UI/UX e Assetto Grafico.</h2>
    ...
    },
    {
      ...
      description: (
        <>
          <h2 className="font-bricolage font-bold text-3xl text-white mb-6">Motore PrestaShop ed Esperienza Utente.</h2>
          <p className="text-white/80 leading-relaxed mb-4">
    ...
    },
    {
      ...
      description: (
        <>
          <h2 className="font-bricolage font-bold text-3xl text-white mb-6">Il lusso della semplicità.</h2>
          <p className="text-white/80 leading-relaxed">
