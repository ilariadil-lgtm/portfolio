  ...
  const phasesData: Phase[] = [
    {
      ...
      description: (
        <>
          <h2 className="font-bricolage font-bold text-3xl text-white mb-6">La cosmetica professionale online.</h2>
    ...
    },
    {
      ...
      description: (
        <>
          <h2 className="font-bricolage font-bold text-3xl text-white mb-6">UI/UX e Architettura del Catalogo.</h2>
    ...
    },
    {
      ...
      description: (
        <>
          <h2 className="font-bricolage font-bold text-3xl text-white mb-6">Configurazione Tecnica PrestaShop.</h2>
          <p className="text-white/80 leading-relaxed mb-4">
    ...
    },
    {
      ...
      description: (
        <>
          <h2 className="font-bricolage font-bold text-3xl text-white mb-6">Estetica e Conversione.</h2>
          <p className="text-white/80 leading-relaxed">
