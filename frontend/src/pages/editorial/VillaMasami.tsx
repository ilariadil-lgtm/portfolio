...
export const EditorialVillaMasami = () => {
  ...
  const techList = ["Brand & Logo Design", "UI/UX Design", "Copywriting", "WordPress (Bilingual)"];
    ...
    <div className="min-h-screen bg-[#f5f2ed] text-[#3d0f1a] selection:bg-primary/30 font-body">
              ...
              <h1 className="relative font-display leading-[0.85] tracking-tighter">
                <div className="overflow-hidden pt-4 pb-24 -mb-20 w-max">
                  <motion.span
                    ...
                    className="block text-[10vw] lg:text-[6vw] font-bold text-[#3d0f1a] whitespace-nowrap pr-4"
                    style={{ y: y1 }}
                  >
                    Villa<span className="text-primary italic pr-2"> Masami</span><span className="text-[#3d0f1a] not-italic pr-2">.</span>
                  </motion.span>
                </div>
              </h1>
      ...
      <section className="w-full h-[60vh] lg:h-[80vh] relative overflow-hidden">
        <motion.img 
          ...
          viewport={{ once: true }}
          src="/assets/projects/villa-masami/camera-matrimoniale.webp" 
          alt="Villa Masami Interior" 
            ...
            <div className="bg-white border border-[#3d0f1a] shadow-[10px_10px_0px_#3d0f1a] p-10 h-full flex flex-col justify-between">
              ...
              <div className="border-t border-[#3d0f1a]/10 pt-6 mt-12 space-y-4 text-[#3d0f1a]">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-display text-md font-black italic pr-2">{t('villamasami.role_val')}</span>
                </div>
                <div className="flex items-center justify-between">
      ...
      <FloatingCTA url="https://villamasami.it" />
      <Footer />
    </div >
  );
};
