...
const NebulaIndex = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const [projData, servData] = await Pro
          ...
          <div className="flex justify-center mt-24">
            <MagneticWrapper>
              <Link to="/progetti" className="group flex items-center gap-6 font-mono text-[10px] uppercase tracking-[0.3em] text-white hover:text-[#d4af37] transition-colors p-4">
